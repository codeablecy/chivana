...
const qualities = [
  {
    icon: Layers,
    title: "Cubiertas",
    description: "Aislamiento y proteccion termica de alta eficiencia para maxima comodidad en todas las estaciones.",
  },
  {
    icon: ShieldCheck,
    title: "Fachadas",
    description: "Acabado exterior con aislamiento termico avanzado y materiales de primera calidad.",
  },
  {
    icon: Droplets,
    title: "Sanitarios y Griferias",
    description: "Equipamiento de bano de primeras marcas con diseno moderno y funcional.",
  },
  {
    icon: Zap,
    title: "Instalaciones",
    description: "Sistemas de aerotermia, suelo radiante refrescante y las mejores prestaciones energeticas.",
  },
]
          ...
          {qualities.map((q) => (
            ...
            >
              <div className="flex items-center justify-center h-12 w-12 rounded-lg bg-white/20 mb-4">
                <q.icon className="h-6 w-6 text-accent-foreground" />
              </div>
