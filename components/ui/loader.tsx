...
const LOADER_MARKS = ["C", "H", "I", "V"] as const
  ...
  return (
    <StyledWrapper
      ...
      className={cn(
        ...
        fullScreen && "min-h-screen w-full items-center justify-center bg-background px-6 py-10",
    ...
    >
      <div className="loader-track" aria-hidden="true">
        {LOADER_MARKS.map((mark) => (
          <div key={mark} className="loader-cell">
            <svg viewBox="0 0 80 80">
              <rect x={8} y={8} width={64} height={64} />
              <text x="50%" y="60%" textAnchor="middle" className="loader-glyph">
                {mark}
              </text>
            </svg>
          </div>
...
const StyledWrapper = styled.div`
  ...
  .loader-cell::before {
    ...
    transform: translate(calc(var(--loader-cell-size) * -0.41), calc(var(--loader-cell-size) * -0.41));
    animation: loaderDotRect var(--loader-duration) cubic-bezier(0.785, 0.135, 0.15, 0.86) infinite;
  }
  ...
  .loader-cell rect {
    ...
    stroke-dashoffset: 0;
    animation: loaderPathRect var(--loader-duration) cubic-bezier(0.785, 0.135, 0.15, 0.86) infinite;
  }
